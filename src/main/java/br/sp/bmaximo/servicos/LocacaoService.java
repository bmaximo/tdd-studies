...
import static br.sp.bmaximo.utils.DataUtils.adicionarDias;
import static br.sp.bmaximo.utils.DataUtils.verificarDiaSemana;
...
public class LocacaoService {
	...
	public Locacao alugarFilme(Usuario usuario, List<Filme> filmes) throws FilmeSemEstoqueException, LocadoraException  {
		...
		for(int i = 0; i < filmes.size(); i++) {
			...
			if(i == 2) valorFilme = valorFilme * 0.75;
			if(i == 3) valorFilme = valorFilme * 0.50;
			if(i == 4) valorFilme = valorFilme * 0.25;
			if(i == 5) valorFilme = 0d;
